  ...
  return (
    <footer className="bg-foreground text-background py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* CTA Section */}
        <div className="text-center mb-12 pb-12 border-b border-muted/20">
        ...
        {/* Copyright */}
        <div className="text-center mt-8 pt-8 border-t border-muted/20 text-sm text-muted-foreground">
